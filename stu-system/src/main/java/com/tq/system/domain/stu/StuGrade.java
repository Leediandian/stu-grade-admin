...
public class StuGrade extends BaseEntity {
    ...
    @Excel(name = "成绩录入时间", width = 30, dateFormat = "yyyy-MM-dd HH:mm:ss")
    private Date gradeEntryTime;
    ...
    public void setGradeEntryTime(Date gradeEntryTime) {
        this.gradeEntryTime = gradeEntryTime;
    }

    public Date getGradeEntryTime() {
        return gradeEntryTime;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
                ...
                .append("gradeEntryTime", getGradeEntryTime())
